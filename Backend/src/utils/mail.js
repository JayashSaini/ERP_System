...
const sendEmail = async (options) => {
  const mailGenerator = new Mailgen({
    theme: 'salted',
    product: {
      name: 'GPC IT Solutions',
      link: 'https://www.gpc-solutions.com/',
    },
  });
  ...
  const mail = {
    from: 'gpc@gmail.com', // We can name this anything. The mail will go to your Mailtrap inbox
...
const emailVerificationMailgenContent = (username, verificationUrl) => {
  return {
    body: {
      name: username,
      intro: 'Welcome to GPC IT Solutions! Please Verify Your Email',
      action: {
        instructions:
